...
public class FINALMove : MonoBehaviour
{
    ...
    void PlayerMoveAndRotation()
    {
        ...
        var forward = transform.worldToLocalMatrix.MultiplyVector(cam.transform.forward);
        var right = transform.worldToLocalMatrix.MultiplyVector(cam.transform.right);
